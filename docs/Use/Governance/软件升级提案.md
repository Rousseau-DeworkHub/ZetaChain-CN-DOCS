...
软件升级提案使网络参与者能够就节点软件的更新达成一致，这些更新可以包括功能、安全性和性能的改进。
...
`content` 字段包含提案的详细信息，包括标题、描述和升级计划。

升级计划指定了升级将在哪个高度执行、升级名称以及升级二进制文件的 URL。

请注意，如果升级提案通过，区块链将在指定高度停止，因此节点运营商将其基础设施配置为在指定高度准备好升级非常重要。